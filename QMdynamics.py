...
TSTEPS = TMAX/DT
TSTEPS_PERT = TPERT/DT
TSTEPS_BACK = (1+EXTRA)*TMAX/DT
...
num_up_t_pert, psi_t = b.diag_ops_dynamics(psi_t, pert_ham, TSTEPS_PERT, DT, num_up_diag)
num_up_t_backwards, psi_t = b.diag_ops_dynamics(psi_t, SYK_ham, TSTEPS_BACK, -DT, num_up_diag)
